  ...
  static Future<void> addSampleData() async {
    ...
    if (box.isEmpty) {
      ...
      await addResponsibility(Responsibility(
        ...
        frequency: 'mensual',
        isPaid: false,
        iconCode: 0xe3a6, // Icons.lightbulb
      ));
      ...
      await addResponsibility(Responsibility(
        ...
        amount: 25000,
        dueDay: 10,
        category: 'cuota_manejo',
        frequency: 'mensual',
        isPaid: false,
        iconCode: 0xe25a, // Icons.credit_card
      ));
      ...
      await addResponsibility(Responsibility(
        ...
        frequency: 'mensual',
        isPaid: false,
        iconCode: 0xe149, // Icons.fitness_center
      ));
      ...
      await addResponsibility(Responsibility(
        ...
        isPaid: true,
        lastPaymentDate: DateTime.now(),
        iconCode: 0xe405, // Icons.music_note
      ));
    }
  }
